  ...
  dashboardHeader(title = "Foreign Insight"),
    dashboardSidebar(
      sidebarMenu(id = "tabs",
        ...
        sliderInput("selectYear", "", min = 2012, max = 2018, value = 2018, sep = "")
    )
  ),
  dashboardBody(
    fluidRow(
      tabItems(
        tabItem(tabName = "tab1",
                box(width = 3, title = "Census Sections", status = "primary", solidHeader = TRUE,
                    ...
                    selectizeInput("selectNacionalidad", label = "Select Nationality", choices = levels(SXnacionalAmbos$nacionalidad), selected = "Bulgaria"),
