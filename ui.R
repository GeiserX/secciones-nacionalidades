      ...
      tabItems(
        tabItem(tabName = "tab1",
                box(width = 3, title = "Census Sections", status = "primary", solidHeader = TRUE,
                    ...
                    selectizeInput("selectMunicipio", label = "Select Municipality", choices = c("Cartagena (Murcia)"), multiple = T, selected = "Madrid (Madrid)"),
                    selectInput("selectNacionalidad", label = "Select Nationality", choices = levels(SXnacionalAmbos$nacionalidad), selected = "Total Población"),
