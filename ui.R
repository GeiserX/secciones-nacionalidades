      ...
      tabItems(
        tabItem(tabName = "tab1",
                box(width = 3, title = "Census Sections", status = "primary", solidHeader = TRUE,
                    selectizeInput("selectProvincia", "Select Province", choices = provincias$Nombre, multiple = F, selected = "Madrid"),
                    selectizeInput("selectMunicipio", label = "Select Municipality", choices = c("Madrid (Madrid)"), multiple = T, selected = "Madrid (Madrid)"),
                    selectInput("selectNacionalidad", label = "Select Nationality", choices = levels(SXnacionalAmbos$nacionalidad), selected = "Bulgaria"),
        ...
        tabItem(tabName = "tab2",
                box(width = 2, title = "Provinces", status = "primary", solidHeader = TRUE,
                    ...
                    selectizeInput("selectNacionalidad2", label = "Select Nationality", choices = levels(SXnacionalAmbos$nacionalidad), selected = "Bulgaria"),
        ...
        tabItem(tabName = "tab3",
                box(width = 2, title = "Spain", status = "primary", solidHeader = TRUE,
                    selectizeInput("selectNacionalidad3", label = "Select Nationality", choices = levels(SXnacionalAmbos$nacionalidad), selected = "Bulgaria")
                ),
